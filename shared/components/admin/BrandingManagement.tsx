          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleColorChange("customDomain", e.target.value)
                }
                className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleColorChange("termsUrl", e.target.value)
                  }
                  className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleColorChange("privacyUrl", e.target.value)
                  }
                  className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleColorChange("supportEmail", e.target.value)
                  }
                  className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
