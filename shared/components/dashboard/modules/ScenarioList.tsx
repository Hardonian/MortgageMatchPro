...
import { Search, Plus, Edit, Trash2, Eye, Star, Clock } from "lucide-react";
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button
            onClick={() => onSaveScenario({}, "affordability", "New Scenario")}
          >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        onToggleFavorite(scenario.id, !scenario.is_favorite)
                      }
                    >
                      <Star
                        className={`h-4 w-4 ${
