...
export function PredictiveStorytellingDashboard({
  ...
  const [selectedStory, setSelectedStory] = useState<PredictiveStory | null>(
    null
  );
  ...
  const mockStories: PredictiveStory[] =
    stories.length > 0
      ? stories
      : [
          {
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">
            Predictive Storytelling Dashboard
          </h1>
          <p className="text-muted-foreground">
            AI-generated narratives explaining your mortgage insights and
            opportunities
          </p>
        </div>
          ...
          >
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                <Badge variant="secondary">{story.modelVersion}</Badge>
              </div>
            ...
            <CardContent>
              <p className="text-sm mb-4 line-clamp-3">{story.narrative}</p>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    {Math.round(story.quantitativeData.confidence * 100)}%
                    confidence
                  </span>
                </div>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Generated{" "}
                    {new Date(selectedStory.generatedAt).toLocaleString()}
                  </p>
                </div>
                <div className="flex gap-2">
                  <Button
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-bold">
                            {typeof selectedStory.quantitativeData
                              .currentValue === "number"
                          ...
                          <span className="font-bold">
                            {typeof selectedStory.quantitativeData
                              ...
                              ? selectedStory.quantitativeData.predictedValue >
                                1000
                                ? formatCurrency(
                                    selectedStory.quantitativeData
                                      .predictedValue
                                  )
                                : `${selectedStory.quantitativeData.predictedValue}%`
                              : selectedStory.quantitativeData.predictedValue}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          >
                            {formatPercent(
                              selectedStory.quantitativeData.changePercent
                            )}
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-bold">
                            {Math.round(
                              selectedStory.quantitativeData.confidence * 100
                            )}
                            %
                          </span>
                        </div>
                ...
                <TabsContent value="risks" className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <ul className="space-y-2">
                          {selectedStory.opportunities.map(
                            (opportunity, index) => (
                              <li
                                key={index}
