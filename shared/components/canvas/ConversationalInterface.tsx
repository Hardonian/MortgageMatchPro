  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi! I'm your AI mortgage advisor. I can help you calculate affordability, compare rates, analyze scenarios, and connect with brokers. What would you like to know?",
      timestamp: new Date(),
      type: "general",
    },
  ]);
      ...
      if (response.success) {
        const assistantMessage: Message = {
          ...
          content:
            ...
            "I understand you need help with mortgages. Let me assist you with that.",
          timestamp: new Date(),
