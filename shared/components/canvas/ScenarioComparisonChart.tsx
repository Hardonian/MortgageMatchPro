      ...
      .map((scenario, index) => ({
        ...
        riskLevel:
          scenario.riskFactors.length > 0
            ? scenario.riskFactors.filter((r) => r.severity === "high").length
            : 0,
      }));
      ...
      comparison.scenarios.forEach((scenario, index) => {
        if (visibleScenarios.has(scenario.scenarioId)) {
          ...
          if (scheduleEntry) {
            ...
            yearData[`scenario${index + 1}_interest`] =
              scheduleEntry.cumulativeInterest;
            yearData[`scenario${index + 1}_principal`] =
                  ...
                  <Card key={scenario.scenarioId}>
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        >
                          {scenario.riskFactors.length} Risk Factor
                          {scenario.riskFactors.length !== 1 ? "s" : ""}
                        </Badge>
                      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-1">
                    {comparison.aiInsights.pros.map(
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {comparison.aiInsights.cons.map(
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {comparison.aiInsights.personalizedAdvice}
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  {comparison.aiInsights.nextSteps.map(
