...
const mockAffordabilityAgent = AffordabilityAgent as jest.MockedClass<
  typeof AffordabilityAgent
>;
...
describe("/api/affordability", () => {
  ...
  it("should calculate affordability successfully", async () => {
    ...
    mockAffordabilityAgent.prototype.calculateAffordability.mockResolvedValue(
      mockResult
    );
