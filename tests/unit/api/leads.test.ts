...
const mockLeadQualificationService = leadQualificationService as jest.Mocked<
  typeof leadQualificationService
>;
const mockBrokerNotificationService = brokerNotificationService as jest.Mocked<
  typeof brokerNotificationService
>;
...
describe("/api/leads", () => {
  ...
  it("should process valid lead submission successfully", async () => {
    ...
    mockLeadQualificationService.processLeadQualification.mockResolvedValue(
