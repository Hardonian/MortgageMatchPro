...
describe("API Edge Cases and Error Handling", () => {
  ...
  describe("API Service Factory Edge Cases", () => {
    ...
    it("should handle service listing", () => {
      ApiServiceFactory.registerService(
        "service1",
        new ApiService({
  ...
  describe("Utility Functions Edge Cases", () => {
    ...
    it("should handle timeout correctly", async () => {
      ...
      await expect(apiUtils.withTimeout(slowRequest, 1000)).rejects.toThrow(
        "Request timeout"
      );
    });
  });
  ...
  describe("Error Message Handling", () => {
    it("should provide user-friendly error messages", () => {
      ...
      expect(apiUtils.handleError(networkError)).toContain(
        "Network connection failed"
      );
      expect(apiUtils.handleError(timeoutError)).toContain("Request timed out");
      expect(apiUtils.handleError(validationError)).toContain(
    ...
    it("should handle unknown error types", () => {
      ...
      expect(apiUtils.handleError(unknownError)).toBe(
