...
describe("Event System Integration", () => {
  ...
  describe("AI Event Flow", () => {
    ...
    it("should handle AI scoring failure", async () => {
      ...
      const originalHandleAIScoringRequested =
        require("../../events/handlers/ai-event-handlers").handleAIScoringRequested;
      jest
        .spyOn(
          require("../../events/handlers/ai-event-handlers"),
          "handleAIScoringRequested"
        )
