...
describe("API Contract Tests", () => {
  ...
  describe("Create User API", () => {
    ...
    it("should handle all valid roles", async () => {
      const validRoles: Array<"admin" | "user" | "viewer"> = [
        "admin",
        "user",
        "viewer",
      ];
  ...
  describe("Get User API", () => {
    ...
    it("should reject get user with missing ID", async () => {
      await expect(userAPI.getUser("")).rejects.toThrow("User ID is required");
    });
  ...
  describe("Update User API", () => {
    ...
    it("should reject update with invalid email", async () => {
      ...
      await expect(userAPI.updateUser(userId, updateData)).rejects.toThrow(
        "Invalid email format"
      );
    });
    ...
    it("should reject update with missing user ID", async () => {
      ...
      await expect(userAPI.updateUser("", updateData)).rejects.toThrow(
        "User ID is required"
      );
    });
  });
  ...
  describe("Delete User API", () => {
    ...
    it("should reject delete with missing user ID", async () => {
      await expect(userAPI.deleteUser("")).rejects.toThrow(
        "User ID is required"
      );
    });
  });
  ...
  describe("API Error Handling", () => {
    it("should handle API errors gracefully", async () => {
      ...
      jest
        .spyOn(errorApiService, "makeRequest")
      ...
      await expect(errorUserAPI.createUser(userData)).rejects.toThrow(
        "API Error"
      );
    });
    ...
    it("should handle network timeouts", async () => {
      ...
      jest
        .spyOn(timeoutApiService, "makeRequest")
        .mockImplementation(
          () =>
      ...
      await expect(timeoutUserAPI.createUser(userData)).rejects.toThrow(
        "Request timeout"
      );
    });
  });
