...
export const trackCanvasOpen = (
  canvasType: "affordability" | "rates" | "scenarios" | "leads"
) => {
...
export const trackRateCheckPurchase = (
  userId: string,
  amount: number,
  currency: string
) => {
...
export const trackScenarioSave = (
  userId: string,
  scenarioType: string,
...
export const trackAffordabilityCalculation = (
  userId: string,
  income: number,
  propertyPrice: number,
  gdsRatio: number
...
export const trackScenarioComparison = (
  userId: string,
...
export const trackDashboardView = (
  userId: string,
  dashboardType: "user" | "broker" | "admin"
) => {
...
export const trackReportExport = (
  userId: string,
  reportType: string,
  format: "pdf" | "csv"
) => {
