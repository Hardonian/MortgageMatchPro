...
export type OpenBankingTransaction = z.infer<
...
export class OpenBankingService {
      ...
      return {
        ...
        error:
          error instanceof Error
            ? error.message
            : "Connection link creation failed",
      };
    }
  }
  ...
  async fetchAccounts(connectionId: string): Promise<{
    ...
    try {
      ...
      switch (connection.provider) {
        case "plaid":
          return await this.fetchPlaidAccounts(
            connection.provider_connection_id
          );
        case "flinks":
          return await this.fetchFlinksAccounts(
            connection.provider_connection_id
          );
        case "yodlee":
          return await this.fetchYodleeAccounts(
            connection.provider_connection_id
          );
        case "truelayer":
          return await this.fetchTrueLayerAccounts(
            connection.provider_connection_id
          );
        default:
  ...
  async fetchTransactions(
    ...
    try {
      ...
      switch (connection.provider) {
        case "plaid":
          return await this.fetchPlaidTransactions(
            connection.provider_connection_id,
            startDate,
            endDate
          );
        case "flinks":
          return await this.fetchFlinksTransactions(
            connection.provider_connection_id,
            startDate,
            endDate
          );
        case "yodlee":
          return await this.fetchYodleeTransactions(
            connection.provider_connection_id,
            startDate,
            endDate
          );
        case "truelayer":
          return await this.fetchTrueLayerTransactions(
            connection.provider_connection_id,
            startDate,
            endDate
          );
      ...
      accounts: [
        {
          ...
          type: "checking",
          subtype: "checking",
          balance: { current: 5000.0, available: 4500.0 },
          mask: "1234",
        },
      ],
    };
      ...
      accounts: [
        {
          ...
          name: "RBC Chequing",
          type: "checking",
          balance: { current: 7500.0, available: 7000.0 },
          mask: "5678",
        },
      ],
    };
  ...
  private async fetchFlinksTransactions(
    accessToken: string,
    startDate: string,
    endDate: string
  ) {
      ...
      accounts: [
        {
          ...
          name: "Test Checking",
          type: "checking",
          balance: { current: 3000.0, available: 2800.0 },
          mask: "9999",
        },
      ],
    };
      ...
      accounts: [
        {
          ...
          name: "Test Checking",
          type: "checking",
          balance: { current: 4000.0, available: 3500.0 },
          mask: "1111",
        },
      ],
    };
  ...
  private async fetchTrueLayerTransactions(
    accessToken: string,
    startDate: string,
    endDate: string
  ) {
  ...
  async storeTransactions(
    ...
    try {
      ...
      return {
        success: false,
        error:
          error instanceof Error ? error.message : "Transaction storage failed",
      };
    }
  }
