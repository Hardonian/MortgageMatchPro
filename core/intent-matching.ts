...
class IntentMatcher {
  ...
  async matchIntent(userInput: string, context?: any): Promise<IntentMatch> {
    try {
      ...
      return {
        ...
        parameters: {},
        suggestedAction:
          "I can help you with mortgage calculations, rate comparisons, scenario analysis, and connecting with brokers. What would you like to know?",
      };
    }
  }
  ...
  private matchPatterns(userInput: string): IntentMatch {
    let bestMatch: IntentMatch = {
      ...
      parameters: {},
      suggestedAction:
        "I can help you with mortgage-related questions. What would you like to know?",
    };
...
Return a JSON response with:
{
  ...
  "reasoning": "brief explanation"
      ...
      return {
        ...
        parameters: {},
        suggestedAction:
          "I can help you with mortgage questions. What would you like to know?",
      };
    }
  }
  ...
  private getSuggestedAction(intent: string): string {
    const actions = {
      calculate_affordability:
        "I can help you calculate how much you can afford to borrow. Let me gather some information about your financial situation.",
      fetch_rates:
        "I can show you current mortgage rates from verified lenders. Let me fetch the latest rates for you.",
      compare_scenarios:
        "I can help you compare different mortgage scenarios. Let me analyze your options.",
      analyze_refinance:
        "I can analyze whether refinancing makes sense for you. Let me check your current situation.",
      connect_broker:
        "I can connect you with qualified mortgage brokers in your area. Let me find the best matches for you.",
      generate_amortization:
        "I can generate a detailed payment schedule for your mortgage. Let me create that for you.",
      general_advice:
        "I can help you with mortgage-related questions. What would you like to know?",
    };
  ...
  getContextualShortcuts(
    context?: any
  ): Array<{ label: string; intent: string; action: string }> {
    const shortcuts = [
      {
        label: "Can I afford a $600K home?",
        intent: "calculate_affordability",
        action: "calculate_affordability",
      },
      {
        label: "Show me current rates",
        intent: "fetch_rates",
        action: "fetch_rates",
      },
      {
      ...
      },
      {
        ...
        intent: "analyze_refinance",
        action: "analyze_refinance",
      },
      {
        label: "Connect with broker",
        intent: "connect_broker",
