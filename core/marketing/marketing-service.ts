...
export class MarketingService {
  ...
  private initializeDefaultPrograms(): void {
    ...
    this.affiliatePrograms.set("default", {
      ...
      description:
        "Earn commissions by referring customers to MortgageMatchPro",
  ...
  private initializeEventHandlers(): void {
    ...
    this.eventBus.subscribe(
      "affiliate.click",
      this.handleAffiliateClick.bind(this)
    );
    this.eventBus.subscribe(
      "referral.used",
      this.handleReferralUsed.bind(this)
    );
  }
  ...
  private async triggerUpgradeCampaign(
    userId: string,
    tenantId: string,
    plan: string
  ): Promise<void> {
  ...
  private async checkReferralReward(
    userId: string,
    tenantId: string,
    amount: number
  ): Promise<void> {
  ...
  private async processReferralSignup(
    userId: string,
    tenantId: string,
    referralCode: string
  ): Promise<void> {
  ...
  private async trackAffiliateClick(
    affiliateId: string,
    userId: string,
    url: string
  ): Promise<void> {
  ...
  private async processReferralUsage(
    referralCode: string,
    userId: string,
    tenantId: string
  ): Promise<void> {
  ...
  async createAffiliateProgram(
    program: Omit<AffiliateProgram, "id" | "createdAt" | "updatedAt">
  ): Promise<string> {
  ...
  async createAffiliateLink(
    link: Omit<AffiliateLink, "id" | "createdAt" | "lastUsed">
  ): Promise<string> {
  ...
  async createFeatureFlag(
    flag: Omit<FeatureFlag, "id" | "createdAt" | "updatedAt" | "metrics">
  ): Promise<string> {
  ...
  private generateShortUrl(affiliateId: string, userId: string): string {
    const baseUrl =
      this.affiliatePrograms.get("default")?.tracking.baseUrl ||
      "https://mortgagematchpro.com/affiliate";
    const trackingCode =
      this.affiliatePrograms.get("default")?.tracking.trackingCode || "aff";
  ...
  private async updateReferralCodeUsage(
    codeId: string,
    userId: string
  ): Promise<void> {
