  ...
  async calculateAffordability(input: {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are the Affordability Agent for MortgageMatch Pro. Calculate mortgage affordability using ${
            input.country === "CA" ? "Canadian OSFI rules" : "US CFPB rules"
          }.
      ...
      messages: [
        {
          role: "system",
          content:
            "You are the Scenario Analysis Agent. Compare mortgage scenarios and provide detailed analysis including amortization schedules, total costs, and recommendations.",
        },
        {
          role: "user",
          content: JSON.stringify(input),
