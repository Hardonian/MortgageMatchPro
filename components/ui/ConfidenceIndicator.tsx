  ...
  return (
    <View style={[currentSize.container, style]}>
      ...
      <View style={styles.barContainer}>
        ...
        <Text style={[currentSize.text, styles.levelText]}>
          {confidenceLevel}
        </Text>
      </View>
      ...
      {factors.length > 0 && (
        <View style={styles.factorsContainer}>
          <Text style={[currentSize.text, styles.factorsLabel]}>
            Key Factors:
          </Text>
            ...
            {factors.slice(0, 3).map((factor, index) => (
              <View key={index} style={styles.factorItem}>
                <Icon
                  ...
                  color="#4CAF50"
                />
                <Text style={[currentSize.text, styles.factorText]}>
                  {formatFactor(factor)}
                </Text>
              </View>
            ))}
      ...
      {showExplanation && onExplanationPress && (
        ...
        >
          ...
          <Text style={[currentSize.text, styles.explanationText]}>
            Why this result?
          </Text>
        </TouchableOpacity>
      )}
...
function getConfidenceColor(confidence: number): {
  ...
  if (confidence >= 0.6) {
    return { start: "#FF9800", end: "#FFC107" };
  }
