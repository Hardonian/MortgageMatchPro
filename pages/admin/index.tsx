      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-700">
            Welcome to the admin console for {organization.name}.
          </p>
        </div>
                ...
                >
                  ...
                  <div className="mt-8">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Invite and manage team members, assign roles and
                      permissions.
                    </p>
                  </div>
                </a>
