  ...
  if (req.method === "POST") {
    try {
      ...
      switch (simulationType) {
        ...
        case "rate_shock":
          result = await scenarioSimulator.runRateShockSimulation(
            userId,
            baseScenario,
            [
        ...
        case "property_decline":
          result = await scenarioSimulator.runPropertyDeclineSimulation(
            userId,
            baseScenario,
            [
        ...
        case "income_variance":
          result = await scenarioSimulator.runIncomeVarianceSimulation(
            userId,
            baseScenario,
            [
        ...
        case "comprehensive":
          result = await scenarioSimulator.runComprehensiveStressTest(
            userId,
            baseScenario
          );
          break;
