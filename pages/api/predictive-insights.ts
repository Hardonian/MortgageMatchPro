...
import {
  ...
  PredictiveInsightsConfig,
} from "@/lib/agents/predictive-orchestrator";
    ...
    try {
      ...
      switch (action) {
        ...
        case "run_user_insights":
          ...
          const userInsights = await orchestrator.runUserPredictiveInsights(
            userId
          );
        ...
        case "get_summary":
          const insightsSummary =
            await orchestrator.getPredictiveInsightsSummary();
